...
ALTER TABLE Paquetes 
	...
	ADD CONSTRAINT fk_Paquete_Cabana FOREIGN KEY (CabanaID) REFERENCES Cabanas(CabanaID)

ALTER TABLE Clientes ADD CONSTRAINT fk_Clientes_Identificacion FOREIGN KEY (IdentificacionID) REFERENCES Identificaciones(IdentificacionID);
