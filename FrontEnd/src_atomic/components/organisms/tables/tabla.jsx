...
function TablaGeneral({ data, acciones, onEdit, onDelete, hideActions }) {
      ...
      <Table>
        <thead>
          <tr>
            ...
            {(!hideActions && (acciones || onEdit || onDelete)) && <th>Acciones</th>}
          </tr>
        </thead>
        <tbody>
          {data.map((fila, i) => (
            <tr key={i}>
              ...
              {(!hideActions && (acciones || onEdit || onDelete)) && (
